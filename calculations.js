...
const handleInputChange = () => {
  ...
  const resultPrice = (1 + Math.floor(sizeIncrements) + Math.floor(contractsIncrements)) * BASE_PRICE;
  ...
  // print
  console.log({million, billion, sizeNumber: formatter.format(sizeNumber), contractsNumber: formatter.format(contractsNumber), resultPrice: formatter.format(resultPrice)});
